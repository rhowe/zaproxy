...
public abstract class HttpPanel extends AbstractPanel implements Tab {
    ...
    public void setMessage(Message msg) {
        ...
        for (Entry<String, HttpPanelComponentInterface> stringHttpPanelComponentInterfaceEntry : components.entrySet()) {
            HttpPanelComponentInterface component = stringHttpPanelComponentInterfaceEntry.getValue();
